...
| **`LP<N>`**   | Latching pulses duration    | • Set Latching pulse duration in ms for latching relays <br> • Example: `LP50` reduces latching pulse duration to 50ms (default 100ms) |
